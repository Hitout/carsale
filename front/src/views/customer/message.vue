<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.customerIdCard" placeholder="身份证号" style="width: 190px;" class="filter-item" @keyup.enter.native="handleFilter"/>
    ...
    <el-table
      ...
      <el-table-column label="身份证号" prop="idCard" align="center" min-width="150px">
        <template slot-scope="scope">
          <!-- <span>{{ scope.row.customerIdCard }}</span> -->
          <span>441752198911232716</span>
        </template>
      </el-table-column>
      <el-table-column label="注册时间" prop="date" sortable="custom" min-width="135px" align="center">
        <template slot-scope="scope">
